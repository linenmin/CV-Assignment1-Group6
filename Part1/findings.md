...
## Notebook Markdown Writing Style

These rules apply to all markdown cells written or edited in `ga1_Group_6.ipynb`.

**Tone and voice**
- Write naturally. If a sentence sounds like it was generated by an AI, rewrite it.
- Be direct, honest, and confident without overstating results.
- Avoid enthusiasm ("excellent", "remarkably", "impressive"). Report what happened.
- Avoid self-congratulation and excessive hedging in equal measure.

**Sentence structure**
- Use short, clear sentences. One idea per sentence where possible.
- No long nested clauses.
- Do not use em-dashes (—) to construct sentences. Use commas, parentheses, or split into two sentences instead.
- Remove mechanical connectors: "First and foremost", "It is worth noting that", "In summary", "As mentioned above". Let logic connect sentences instead.

**Word choice**
- Use plain, precise academic vocabulary. Prefer "use" over "leverage", "investigate" over "delve into", "context" over "tapestry".
- Only use technical terms when they carry a specific meaning that a plain word cannot. Do not stack jargon for the appearance of rigor.
- Avoid overused vague intensifiers: "significant", "substantial", "notable" unless backed by a number.

**Editing principle**
- If the existing text is already natural and accurate, leave it alone. Do not edit for the sake of editing.
